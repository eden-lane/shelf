...
export const FolderDisclosurePlaceholder = () => <span className="h-6 w-4 shrink-0" aria-hidden="true" />;
...
export const FolderDisclosureControl = ({
  ...
  return (
    ...
    >
      {isCollapsed ? (
        <IconChevronRight size={14} stroke={1.5} aria-hidden="true" focusable="false" />
      ) : (
