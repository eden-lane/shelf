      ...
      <Dialog.Portal>
        ...
        <Dialog.Popup className="fixed top-1/2 left-1/2 z-50 grid w-[min(calc(100vw-32px),420px)] -translate-x-1/2 -translate-y-1/2 grid-rows-[auto_minmax(0,1fr)] gap-5 rounded-lg border border-[#e4e7ef] bg-white p-5 text-[#242833] shadow-[0_24px_80px_rgb(22_28_43_/_0.22)] outline-none max-md:inset-0 max-md:top-0 max-md:left-0 max-md:h-dvh max-md:w-screen max-md:translate-x-0 max-md:translate-y-0 max-md:rounded-none max-md:border-0 max-md:p-0 max-md:shadow-none">
          <div className="grid gap-1 pr-9 max-md:border-b max-md:border-[#eef1f6] max-md:px-4 max-md:pt-[calc(1rem+env(safe-area-inset-top))] max-md:pb-3">
            <Dialog.Title className="text-lg leading-[1.25] font-medium">
          ...
          >
            <div className="grid min-h-0 content-start gap-4 overflow-y-auto overscroll-contain max-md:px-4 max-md:py-4">
              <label className="grid gap-2 text-sm font-medium" htmlFor="savedItem-url">
                Page URL
                <input
                  className={[
                      ...
                      <Combobox.Value>
                        {(value: TagComboboxOption[]) => (
                          <>
                            {value.map((option) => (
                              <Combobox.Chip
                                className="group flex min-h-7 max-w-full cursor-default items-center gap-1.5 overflow-hidden rounded-md border border-[#dfe4ef] bg-[#f7f8fc] py-0 pr-1 pl-2 text-sm font-medium text-[#4b5262] outline-none focus-within:border-[#3b8df5] focus-within:ring-2 focus-within:ring-[#d9eaff] data-highlighted:border-[#3b8df5]"
                      ...
                      <Combobox.Popup className="max-h-[min(260px,var(--available-height))] w-[var(--anchor-width)] max-w-[var(--available-width)] overflow-y-auto overscroll-contain rounded-lg border border-[#dfe4ef] bg-white py-1 text-[#242833] shadow-[0_16px_48px_rgb(22_28_43_/_0.18)] outline-none">
                        ...
                        <Combobox.List>
                          {(option: TagComboboxOption, index: number) => (
                            <Combobox.Item
                              className="grid min-h-10 cursor-default grid-cols-[1rem_minmax(0,1fr)] items-center gap-2 px-3 py-2 text-sm font-medium text-[#4b5262] outline-none select-none data-highlighted:bg-[#f0f6ff] data-highlighted:text-[#242833] data-selected:text-[#242833]"
                              index={index}
                              key={getTagOptionValue(option)}
                              value={option}
                            >
            ...
            <div className="flex justify-end gap-2 max-md:border-t max-md:border-[#eef1f6] max-md:bg-white max-md:px-4 max-md:pt-3 max-md:pb-[calc(1rem+env(safe-area-inset-bottom))]">
              <Dialog.Close
                className="min-h-10 rounded-lg border border-[#dfe4ef] bg-white px-3 text-sm font-medium text-[#4b5262] outline-none hover:bg-[#f7f8fc] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#3b8df5] max-md:flex-1"
              ...
              <button
                className="min-h-10 rounded-lg border border-[#3b8df5] bg-[#3b8df5] px-3 text-sm font-medium text-white outline-none hover:bg-[#2f80ed] disabled:cursor-not-allowed disabled:border-[#91bff8] disabled:bg-[#91bff8] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#3b8df5] max-md:flex-1"
                disabled={addSavedItem.isPending}
                type="submit"
              >
